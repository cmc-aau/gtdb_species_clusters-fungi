...
from gsc_fungi.ncbi import MetadataNCBI, NCBI_COMPLETE_GENOME, NCBI_ENV_GENOME
...
def assembly_quality(completeness: float, contamination: float) -> float:
    """Caculate assembly quality for genome."""
